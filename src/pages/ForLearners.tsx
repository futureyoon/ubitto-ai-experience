...
const ForLearners = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {valueProps.map((prop, index) => {
              ...
              return (
                <Card key={index} className="border-2 hover:border-primary/40 transition-all animate-fade-in">
                  <CardHeader>
                  ...
                  <CardContent>
                    <CardDescription className="text-base">{prop.desc}</CardDescription>
                  </CardContent>
                </Card>
              );
            })}
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="relative animate-fade-in">
                  <Card className="border-2 hover:border-primary/40 transition-all h-full">
                    <CardHeader>
      ...
      {/* Before/After Use Cases Section */}
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {useCases.map((useCase, index) => (
              <Card key={index} className="border-2 hover:border-primary/40 transition-all animate-fade-in">
                <CardHeader>
                  <div className="bg-gradient-to-br from-primary/5 to-accent/5 px-6 py-5 border-b -mx-6 -mt-6 mb-6">
